...
public class Shanon_Fano extends ComprimirYDescomprimir{
    ...
    public HashMap<Character,String> generarAlfabetoCodigo(HashMap<Character,Float> probabilidades){
        if(probabilidades.size()==2) {
        	...
        	ArrayList<Character> claveOrdenada = this.ordenarProbabilidades(probabilidades);
        	HashMap<Character,Float> conjunto1 = generaConjunto1(probabilidades,claveOrdenada);
        	HashMap<Character,String> mapCodigo1 = this.generarAlfabetoCodigo(conjunto1);
        	HashMap<Character,String> mapCodigo2 = this.generarAlfabetoCodigo(generaConjunto2(conjunto1,probabilidades));
	...
	private HashMap<Character, Float> generaConjunto2(HashMap<Character, Float> conjunto1, HashMap<Character,Float> probabilidades) {
	...
	private HashMap<Character, Float> generaConjunto1(HashMap<Character, Float> probabilidades,ArrayList<Character> claveOrdenada) {
        ...
        System.out.print("Conjunto1 : "+conjunto1+"\n");
		return conjunto1;
	}

	public ArrayList<Character> ordenarProbabilidades(HashMap<Character, Float> probabilidades) {
